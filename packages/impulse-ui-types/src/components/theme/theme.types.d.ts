...
type ComponentColors = Partial<ColorsKeysValues & {
...
export type { AppTheme, ColorsKeysValues, ComponentColors, ComponentsThemes, CustomITheme, DataAttribute, IThemeContext, IThemeProviderProps, ThemeMode, UseIThemeContextFn, };
