...
type Flexbox = 'flexBasis' | 'flexDirection' | 'flexWrap' | 'justifyContent' | 'alignItems' | 'alignContent' | 'order' | 'flex' | 'flexGrow' | 'flexShrink' | 'alignSelf' | 'justifyItems' | 'justifySelf';
type FlexboxKeys = Extract<Flexbox, keyof StandardCSSProperties>;
type FlexboxCssProps = {
    [K in FlexboxKeys]: StandardCSSProperties[K];
};
type Grid = 'gap' | 'columnGap' | 'rowGap' | 'gridColumn' | 'gridRow' | 'gridAutoFlow' | 'gridAutoColumns' | 'gridAutoRows' | 'gridTemplateColumns' | 'gridTemplateRows' | 'gridTemplateAreas' | 'gridArea';
...
type Sizing = 'width' | 'maxWidth' | 'minWidth' | 'height' | 'maxHeight' | 'minHeight' | 'sizeWidth' | 'sizeHeight' | 'boxSizing';
type SizingKeys = Extract<Sizing, keyof StandardCSSProperties>;
type SizingCssProps = {
    [K in SizingKeys]: StandardCSSProperties[K];
};
type SpacingAliases = 'm' | 'mt' | 'mr' | 'mb' | 'ml' | 'mx' | 'my' | 'p' | 'pt' | 'pr' | 'pb' | 'pl' | 'px' | 'py' | 'marginX' | 'marginY' | 'paddingX' | 'paddingY';
type Spacing = 'margin' | 'marginTop' | 'marginRight' | 'marginBottom' | 'marginLeft' | 'marginInline' | 'marginInlineStart' | 'marginInlineEnd' | 'marginBlock' | 'marginBlockStart' | 'marginBlockEnd' | 'padding' | 'paddingTop' | 'paddingRight' | 'paddingBottom' | 'paddingLeft' | 'paddingInline' | 'paddingInlineStart' | 'paddingInlineEnd' | 'paddingBlock' | 'paddingBlockStart' | 'paddingBlockEnd';
...
type Typography = 'fontFamily' | 'fontSize' | 'fontStyle' | 'fontWeight' | 'letterSpacing' | 'lineHeight' | 'textAlign' | 'textTransform';
...
type CssMapKeys = Borders | Display | Flexbox | Grid | Positions | Sizing | Spacing | SpacingAliases | Typography | Colors;
export type { Borders, BordersCssProps, BordersKeys, Colors, ColorsCssProps, ColorsKeys, CssMapKeys, Display, DisplayCssProps, DisplayKeys, Flexbox, FlexboxCssProps, FlexboxKeys, Grid, GridCssProps, GridKeys, Positions, PositionsCssProps, PositionsKeys, Sizing, SizingCssProps, SizingKeys, Spacing, SpacingAliasCssProps, SpacingAliases, SpacingCssProps, SpacingKeys, Typography, TypographyCssProps, TypographyKeys, };
