...
import { BasicAutoCompleteRestProps, InnerSimpleOption } from '../../../basic-auto-complete';
import { InputValue } from '../../../input';
import { dropdownModifiers, processOptions } from '../helpers/basicAutocompleteHelpers';
...
const useBasicAutoComplete = (rest: BasicAutoCompleteRestProps) => {
  const {
    options,
